<template>
    <div class="content min-vh-100" v-if="userInfo">
        ...
        <!--                    &lt;!&ndash; todo: zempie 백엔드 nickname 추가후 수정&ndash;&gt;-->
        <!--                    &lt;!&ndash;                    <p class="user-short-description-text">&ndash;&gt;-->
        <!--                    &lt;!&ndash;                        @{{ userInfo.nickname }}&ndash;&gt;-->
        <!--                    &lt;!&ndash;                    </p>&ndash;&gt;-->
        <!--                </div>-->
        ...
        <!--                    </div>-->
        <!--                    &lt;!&ndash;todo :젬파이 백엔드 following_cnt 수정해야댐&ndash;&gt;-->
        <!--                    <div class="user-stat big">-->
        <!--                        <router-link-->
        <!--                            class="user-stat-title"-->
        ...
        <!--                >-->
        <!--                    &lt;!&ndash;                    todo:following 여부 백엔드 추가 필요 &ndash;&gt;-->
        ...
        <div class="visual-info-center"
            ...
            <dl>
                ...
                <dd>
                    <div
                        :style="`background:url(${profileImg}) center center / cover no-repeat; background-size:cover;`">
                        <!--                        <span></span>-->
                    </div>
                    <h2>
                        {{ userInfo.name }}
                ...
                <dt> <FollowBtn v-if="user&&(userInfo.id !== user.id)" class="follwo-btn":member="userInfo" @refetch="refetch"/></dt>
