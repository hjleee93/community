  ...
  <div class="modal-popup">
        ...
        <form class="form" @submit.prevent="submit">
          ...
          <div class="form-row" style="flex-direction: column">
            <div class="checkbox-wrap">
              ...
              <label for="report-description" class="report-reason">기타</label>
          ...
          <div class="popup-box-actions medium void">
            ...
            <p
              ...
              :style="isValidateError ? 'color:red;' : 'display:none;'"
            >
              신고사유를 입력해주세요
            </p>
          </div>
    ...
    >
      <template #default="{ close }">
        ...
        <button class="popup-box-action full button secondary" @click="close()">
          확인
        </button>
      </template>
    </b-modal>
