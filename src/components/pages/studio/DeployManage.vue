        ...
        <div class="info-input">
            ...
            <div v-if="version" class="ii-form">
                ...
                <ol>
                    ...
                    <li>
                        <a @click="$modal.show('undeployConfirm')" class="btn-gray w100p">{{ $t('deployManage.undeploy.title') }}</a>
                    </li>
                </ol>
            </div>
            ...
            <div class="modal-alert">
                ...
                <div class="ma-content">
                    ...
                    <div class="stage-select-container">
                        ...
                        <v-select class="stage-select-box"
                                  :reduce="name => name.stage"
                                  label="name"
                            ...
                            <template #open-indicator="{ attributes }">
                                <span v-bind="attributes"><i class="uil uil-angle-down"
